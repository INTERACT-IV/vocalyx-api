...
class TranscriptionUpdate(BaseModel):
    ...
    enrichment_prompts: Optional[str] = None  # Prompts utilisés pour l'enrichissement (JSON stringifié)
    enriched_segments: Optional[str] = None  # Segments enrichis (JSON stringifié)
